...
object SharedPreferenceManager {
    ...
    private lateinit var storedSearchHistoryList: ArrayList<SearchedItem>
    ...
    //검색 목록 가져오기
    fun getSearchHistoryList(): ArrayList<SearchedItem> {
        ...
        if (storedSearchHistoryListString.isNotEmpty()) {
            ...
            storedSearchHistoryList =
                Gson()
                    .fromJson(storedSearchHistoryListString, Array<SearchedItem>::class.java)
                    .toMutableList() as ArrayList<SearchedItem>
        }
        return storedSearchHistoryList
    }

    // 검색 목록을 저장
    fun storeSearchHistoryList(searchHistoryList: ArrayList<SearchedItem>) {
